    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {[
          ...
          { label: "This Week", value: stats.thisWeekCount },
          { label: "Last Week", value: stats.lastWeekCount },
          { label: "This Month", value: stats.thisMonthCount },
          { label: "Last Month", value: stats.lastMonthCount },
        ].map((stat, i) => (
          <div key={i} className="bg-white border border-stone-200 rounded-lg p-4 shadow-sm flex flex-col justify-center">
